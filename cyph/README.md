...
**This README was generated by an AI system. It may contain mistakes or
omissions. Verify technical details before relying on them.**
...
Minimum password: - 12+ random characters or - 5+ random words

For sensitive data: - 16+ random characters - Use -level 1 or -level 2

Avoid: - Dictionary-only passwords - Reused passwords
